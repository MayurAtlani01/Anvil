...
export const Hero: React.FC<HeroProps> = ({ onGetAnvil, onSeeHowItWorks }) => {
  return (
    <section className="relative pt-24 pb-14 sm:pt-32 sm:pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[550px] md:w-[700px] h-[300px] sm:h-[400px] md:h-[450px] bg-[#FF6B5A]/10 rounded-full blur-[100px] sm:blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8 text-left">
            {/* Eyebrow */}
            <div className="text-[11px] sm:text-xs md:text-sm font-semibold tracking-[0.16em] sm:tracking-[0.25em] text-[#A7A7A7] uppercase">
              READ &nbsp;|&nbsp; LEARN &nbsp;|&nbsp; PREPARE &nbsp;|&nbsp; GROW
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#F5F5F5] tracking-tight leading-[1.08]">
              Your browser. <br />
              <span className="text-[#FF6B5A]">Sharper.</span>
            </h1>

            {/* Description */}
            <p className="text-[#A7A7A7] text-sm sm:text-base md:text-lg leading-relaxed max-w-lg font-normal">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2">
              ...
              <button
                type="button"
                onClick={onGetAnvil}
                className="w-full sm:w-auto justify-center inline-flex items-center gap-3 px-6 py-3.5 rounded-full bg-[#FF6B5A] hover:bg-[#FF7A6A] active:bg-[#FF5A48] text-[#111111] font-bold text-base transition-all duration-200 shadow-coral hover:shadow-coralGlow hover:-translate-y-0.5 cursor-pointer"
              >
                {/* Google Chrome Icon */}
              ...
              <button
                ...
                className="w-full sm:w-auto justify-center inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full bg-[#181818] hover:bg-[#222222] border border-[#2E2E2E] text-[#F5F5F5] font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
              >
                <div className="w-5 h-5 rounded-full bg-[#2A2A2A] flex items-center justify-center text-[#FF6B5A] shrink-0">
            ...
            {/* Trust Badges */}
            <div className="flex flex-wrap items-center gap-3 sm:gap-6 pt-3 text-xs font-medium text-[#A7A7A7]">
              {/* Chrome Badge */}
