      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="space-y-4 mb-10 sm:mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-end">
            ...
            <div className="lg:col-span-6">
              <p className="text-[#A7A7A7] text-sm sm:text-base md:text-lg leading-relaxed max-w-xl">
          ...
          {modes.map((mode) => {
            ...
            return (
              <div
                key={mode.id}
                id={mode.id}
                className="group relative rounded-2xl bg-[#171717] border border-[#262626] p-5 sm:p-7 flex flex-col justify-between transition-all duration-300 hover:border-[#3A3A3A] hover:-translate-y-1 hover:shadow-2xl shadow-black/40"
              >
                ...
                <div>
                  ...
                  {/* Description */}
                  <p className="text-xs sm:text-sm text-[#A7A7A7] leading-relaxed mb-5 sm:mb-6 font-normal">
                    {mode.description}
                  </p>
                </div>

                {/* Pills / Tags Section */}
                <div className="pt-4 border-t border-[#222222] flex flex-wrap gap-1.5 sm:gap-2">
                  {mode.pills.map((pill) => {
                    ...
                    return (
                      <button
                        ...
                        className={`text-[11px] sm:text-xs px-2.5 sm:px-3 py-1.5 rounded-lg border transition-all cursor-pointer ${
                          isSelected
        ...
        {selectedTag && (
          <div className="mt-6 flex items-center justify-center animate-in fade-in duration-200 px-2">
            <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-xl sm:rounded-full bg-[#1F1F1F] border border-[#FF6B5A]/40 text-xs text-[#F5F5F5] shadow-lg max-w-xl text-left">
              <CheckCircle2 className="w-4 h-4 text-[#FF6B5A] shrink-0" />
